...
class ServiceToServiceCallHandler
{
    ...
    public function getYouthIssuedCertificate(int $youthId, int $issueId): mixed
    {

        $url = clientUrl(BaseModel::INSTITUTE_URL_CLIENT_TYPE) . 'service-to-service-call/get-youth-certificate-issued/' . $youthId . '/issue-id/' . $issueId;
