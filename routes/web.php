...
$router->group(['prefix' => 'api/v1', 'as' => 'api.v1'], function () use ($router, $customRouter) {
    ...
    $router->get('youth-auth-source', ["as" => "youth-auth-source.get-youth-auth-source", "uses" => "YouthProfileController@getYouthAuthSource"]);
...
//    $router->post('youth-cv-download/{id}', ["as" => "youth.cv-download", "uses" => "YouthProfileController@youthCvDownload"]);
    ...
    $router->group(['prefix' => 'service-to-service-call', 'as' => 'service-to-service-call'], function () use ($router) {
        ...
        $router->post("update-trainer-youth", ["as" => "update-trainer-youth", "uses" => "YouthController@updateTrainerYouth"]);
    });
...
$router->group(['prefix' => 'api/v1/', 'as' => 'api.v1', 'middleware' => "auth"], function () use ($router, $customRouter) {
    ...
    $router->get('youth-issued-certificate/{issueId}', ['as' => 'youth-profile.youth-issued-certificate', 'uses' => 'YouthProfileController@getYouthIssuedCertificate']);
