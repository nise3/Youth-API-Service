...
return [
    ...
    */
    [
        ...
        'gte' => [
            'numeric' => 'The :attribute must be greater than or equal :value.[28001]',
            'file' => 'The :attribute must be greater than or equal :value kilobytes.[28002]',
            'string' => 'The :attribute must be greater than or equal :value characters.[28003]',
        ...
        'lte' => [
            'numeric' => 'The :attribute must be less than or equal :value.[38001]',
            'file' => 'The :attribute must be less than or equal :value kilobytes.[38002]',
            'string' => 'The :attribute must be less than or equal :value characters.[38003]',
            'array' => 'The :attribute must not have more than :value items.[38004]',
        ],
        'max' => [
            'numeric' => 'The :attribute may not be greater than :max.[39001]',
            'file' => 'The :attribute may not be greater than :max kilobytes.[39002]',
            'string' => 'The :attribute may not be greater than :max characters.[39003]',
            'array' => 'The :attribute may not have more than :max items.[39004]',
        ],
